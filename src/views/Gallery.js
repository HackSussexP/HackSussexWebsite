...
const Gallery = () => {
  ...
  const images = [
    ...
    { id: 34, url: w1, description: 'INTRODUCTORY ROBOTICS WORKSHOP', event: 'workshops' },
    { id: 35, url: w3, description: '2022 CAPTURE THE FLAG TEAM TAKING ON A CHALLENGE', event: 'workshops' },
    { id: 36, url: w4, description: '2023 LEETCODING WORKSHOP', event: 'workshops' },
    { id: 37, url: w5, description: '2023 ROBOTICS WORKSHOP', event: 'workshops' },
    { id: 38, url: w6, description: 'INTRODUCTORY ROBOTICS WORKSHOP INSTRUCTIONS TO DEVELOP A CIRCUIT', event: 'workshops' },
    { id: 39, url: w7, description: 'GROUP WORKING WITH SENSORS IN A ROBOTICS WORKSHOP', event: 'workshops' },
