    ...
    <div className={`container ${styles.container} mt-5 ms-auto me-auto`}>
      ...
      <div className='row mb-3'>
        ...
        <div className='col-12 col-lg-6 p-5 m-auto order-2 order-lg-1 text-center text-lg-end'>
          <img src={GameJam} alt="game-jam" className='img-fluid rounded event-logo' style={{objectFit: 'contain'}}></img>
        </div>
      </div>
      <div className='row mb-3'>
        <div className='col-12 col-lg-6 m-auto text-lg-end px-3'>
      ...
      <div className='row mb-3'>
        ...
        <div className='col-12 col-lg-6 p-5 m-auto order-2 order-lg-1 text-center text-lg-end'>
          <img src={Pwnsussex} alt="pwn-sussex" className='img-fluid rounded event-logo' style={{objectFit: 'contain'}}></img>
        </div>  
      </div>
    </div>
  );
