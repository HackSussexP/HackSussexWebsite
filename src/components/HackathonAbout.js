    ...
    <>
        <div className='container d-none d-sm-block w-75'>
            <AboutSection description={<>
                <p>HackSussex2024 is almost upon us! This unique event is hosted over a full weekend, including 24 hours of non-stop coding, workshops hosted by our sponsors, 5 mouth-wateringly tasty meals from local Brighton caterers, snacks and drinks, and an exclusive 2025 t-shirt, <strong>all for free</strong>!</p>
